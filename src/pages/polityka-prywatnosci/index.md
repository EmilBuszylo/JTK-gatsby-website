...
meta_description: >-
  Polityka prywatności strony www, jest bardzo ważnym dokumentem, którym należy
  zapoznać się przed przekazaniem Nam swoich danych osobowych, które w dalej
  będą przez Nas przetwarzane dla uzyskania określonego celu.
---
## Polityka prywatności

Odwiedzając naszą stronę internetową, powierzasz Nam swoje dane osobowe do wykonania konkretnych usług i celów. W trosce o ochronę Twojej prywatności JTLS Technika s.c. opracowała i przyjęła dla zagwarantowania zachowania bezpieczeństwa i ochrony przetwarzanych danych osobowych politykę prywatności. Niniejsza Polityka prywatności służy jako pomoc w zrozumieniu jakie dane i w jakim celu pozyskujemy. 
...
Ma zastosowanie do każdego przypadku, w którym Jesteśmy administradorem danych osobowych i przetwarzamy dane osobowe. Pozyskane dane mogą być bezpośrednio od osoby, której dane dotyczą i pozyskaliśmy je bezpośrednio, jak i w przypadku, w którym dane osobowe pozyskaliśmy z innych źródeł. 
...
\- działań podejmowanych przez Nas na Twoją recz. Przykładowo, jeżeli chcesz zadać Nam pytanie możesz zostać poproszony o podanie określonego zakresu danych osobowych w zależności od treśi wybranego zagadnienia
...
Pozyskanych danych nie udostępniamy firmom, organizacjom ani osobom spoza JTLS Technika s.c. jeżeli nie zaistnieje jedna z następujących okoliczności:

\- pozyskamy od Was zgodę – w takim przypadku możemy udostępnić dane osobowe firmom, organizacjom i osobom spoza JTLS Technika s.c. w celu niezbędnym dla wykonania usługi

\- istnieją przyczyny prawne, gdzie dane udostępniamy firmom, organizacjom i osobom spoza JTLS Technika s.c., gdzie użycie danych jest uzasadnione w związku z:
...
\- ochroną praw własności lub bezpieczeństwa Administratora Danych, użytkowników strony JTLS Technika s.c., oraz pozostałych osób w sposób wymagany bądź dozwolony przez przepisy prawa.
...
Wnioski dotyczące  realizacji niniejszych uprawnień możecie składać pisemnie lub elektronicznie na adres **ochronadanych@jtlsklima.pl.**
...
Polityka przetwarzania danych osobowych obowiązuje od dnia 30 maja 2019 r.
